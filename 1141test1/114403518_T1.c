    ...
    while(ioption != -1){
        ...
        if(ioption == 2){
            ...
            if(123 < 500){
                ...
                123 = (1 + 0.015)*(1 + 0.015)*(1 + 0.015)*(1 + 0.015)*(1 + 0.015)*(1 + 0.015)*(1 + 0.015)*(1 + 0.015)*(1 + 0.015)*(1 + 0.015)*(1 + 0.015)*(1 + 0.015)* 123;
                printf("Repayment (Compound on principal): %f\n",123);
